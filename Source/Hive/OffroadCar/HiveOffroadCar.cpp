...
#include "HiveOffroadCar.h"
#include "HiveOffroadWheelFront.h"
#include "HiveOffroadWheelRear.h"
...
AHiveOffroadCar::AHiveOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UHiveOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UHiveOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UHiveOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UHiveOffroadWheelRear::StaticClass();
